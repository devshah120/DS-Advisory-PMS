 ...
 * windows, 'CUSTOM', or a named quarter like 'Q3-CY26'. A string rather than a
 * closed union because the quarter codes are generated from the calendar — the
 * selectable list comes from `periods()` below, not from this type.
 */
...
export interface PeriodReturn {
  ...
  /** Human label for the window, e.g. "Q3 CY26". */
  label: string;
  from: string;
  to: string;
...
export const portfolioHistoryApi = {
  ...
  /**
   * The selectable periods, generated by the backend from the calendar so the
   * dropdown can never offer a window `resolvePeriod` would reject.
   */
  ...
  /** `period` is any code from `periods()` — 'INCEPTION', 'QTD', 'Q3-CY26', … */
